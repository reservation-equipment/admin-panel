...
import { Alert } from "@src/shared/hooks/useAlert.tsx";
    ...
    const renderPopup = (typeModal: ModalTypes) => {
        switch (typeModal) {
            case ModalTypes.UPDATE_EQUIPMENT:
                return <UpdateCard id={props.id} setAlert={props.setAlert} close={handleClose}/>
            case ModalTypes.UPDATE_AREA:
                return <UpdateArea {...props} close={handleClose}/>
            case ModalTypes.CONFIRM_MODAL:
                return <ModalConfirm actionFunc={props.actionFunc}
                                  msg={props.msg}
